...
async function loadRecipe() {
    ...
    try {
        ...
        // =========================
            ...
            response = await fetch(
                "http://localhost:5000/api/recipes/name/" +
...
if(commentList){
    ...
    let response = await fetch(
        "http://localhost:5000/api/comments/" + recipe._id
    );
...
async function likeReply(commentId, replyId){
    ...
    await fetch(
        ...
        "http://localhost:5000/api/comments/reply/like/" +
        commentId +
        "/" +
        replyId,
...
async function reportReply(commentId, replyId){
    ...
    let response = await fetch(
        ...
        "http://localhost:5000/api/comments/reply/report/"
        + commentId +
        "/" +
        replyId,
...
async function pinComment(id){
    ...
    let response = await fetch(
        "http://localhost:5000/api/comments/pin/" + id,
        {
            method:"PUT",
