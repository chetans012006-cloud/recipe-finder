...
async function loadAdminRecipes(){
    ...
    let response = await fetch(
        "https://recipe-finder-gdak.onrender.com/api/admin/recipes",
        {
            headers:{
                "Authorization":
...
"https://recipe-finder-gdak.onrender.com/api/admin/recipe/"
+
id,
...
console.log(
    ...
    let response = await fetch(
        ...
        "https://recipe-finder-gdak.onrender.com/api/admin/recipe/" + id,
...
async function loadReportedComments(){
    ...
    let response = await fetch(
        "https://recipe-finder-gdak.onrender.com/api/admin/reported-comments",
        {
            headers:{
                "Authorization":
                "Bearer " + localStorage.getItem("token")
...
"https://recipe-finder-gdak.onrender.com/api/admin/comment/"+id,
...
"https://recipe-finder-gdak.onrender.com/api/admin/stats",
...
"https://recipe-finder-gdak.onrender.com/api/admin/users",
...
"https://recipe-finder-gdak.onrender.com/api/admin/user/"+id+"/role",
...
"https://recipe-finder-gdak.onrender.com/api/admin/user/"+id,
